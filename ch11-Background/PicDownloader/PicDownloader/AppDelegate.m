...
//If your app terminates before the download completes, when the download does finally complete or failed,
//your app is re-launched, and the app delegate is called

// Use this method to reconnect any URL sessions and to update your app’s user interface using same identifier
